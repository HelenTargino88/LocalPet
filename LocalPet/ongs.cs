...
namespace LocalPet
{
    public class Ongs
    {
        ...
        public Ongs(int id, string nome, string cnpj, string cpf, string descricao, string imagem_ong, Usuarios user)
        {
            Id = id;
            Nome = nome;
            Cnpj = cnpj;
        ...
        {
            var cmd = Banco.Abrir();
            cmd.CommandText = "insert ongs(nome, cnpj, cpfResponsavel, descricao, imagem_ong, usuario_id) values('" + Nome + "','" + Cnpj + "','" + Cpf + "','" + Descricao + "','" + Imagem_ong + "')";
            cmd.ExecuteNonQuery();
        ...
        {
            var cmd = Banco.Abrir();
            cmd.CommandText = "update ongs set nome = '" + Nome + "', cnpj = '" + Cnpj + "', cpfResponsavel = '" + Cpf + "',' descricao ='" + Descricao + "','imagem_ong = '" + Imagem_ong + ",' 'where id =" + Id;
            cmd.ExecuteReader();
        }
        public static void Atualizar(Ongs ongs)
        {
            var cmd = Banco.Abrir();
            cmd.CommandText = "update ongs set " + "nome = '" + ongs.Nome + "', cnpj = '" + ongs.Cnpj + "', cpfResponsavel = '" + ongs.Cpf + "',' descricao ='" + ongs.Descricao + "','imagem_ong = '" + ongs.Imagem_ong + ",' 'where id =" + ongs.Id;
            cmd.ExecuteReader();
        }
